...
public class SLIMCurveTest {
	...
	public void testFitLMA() {
		...
		assertEquals("a value is not correct", _a, (int)param[1]);
		assertEquals("tau value is not correct", _tau, (int)param[2]);
		assertEquals("z value is not correct", _z, (int)param[0]);
		assertEquals("Chi squared value is not correct", _x2, (int)chiSquare[0] / chi_sq_adjust);
